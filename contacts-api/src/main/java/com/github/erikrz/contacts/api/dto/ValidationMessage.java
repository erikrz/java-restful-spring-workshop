...
/**
 * DTO to describe Validation exceptions raised by Spring.
 *
 * @author erikrz
 * @see ObjectError
 * @see BindingResult
...
public class ValidationMessage {
    ...
    @JsonIgnore
    @Schema(
            description = "The array of arguments used to resolve this message",
            example =
                    """
                                                                            [
                                                                                    {
    ...
    @Schema(
            description = "Whether this error represents a binding failure (like a type mismatch); "
