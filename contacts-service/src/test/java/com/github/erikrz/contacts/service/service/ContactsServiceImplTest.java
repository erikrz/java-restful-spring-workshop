...
class ContactsServiceImplTest {
    ...
    void whenSaveContact_thenReturnsValidSavedContact() {
        ...
        when(contactsRepository.save(any(Contact.class))).thenReturn(contact);
    ...
    void whenUpdateContact_thenReturnsUpdatedContact() {
        ...
        when(contactsRepository.findById(1L)).thenReturn(Optional.of(existingContact));
        when(contactsRepository.save(updatedContact)).thenReturn(updatedContact);
